...
:::tip 什么是李跳跳
李跳跳 是一款专为安卓手机设计的广告跳过软件，由开发者@李跳跳在酷安平台上开发。它的主要功能是帮助用户自动跳过各种应用程序中的启动页广告，包括但不限于开屏广告和弹窗广告。

李跳跳的界面设计简洁明了，操作简单，无需Root权限，也无需联网，因此提高了使用的安全性。软件会自动扫描并识别已安装的应用程序，根据内置的规则来决定是否启用跳过广告功能，支持范围广泛，甚至包括一些系统自带的应用程序。

此外，李跳跳还提供了一些额外的功能，如跳过“青少年模式”的提示，以及标准、测试和父母三种模式，以满足不同用户的需求。用户可以通过点击“更多”-“重要提示”来在手机设置中为李跳跳开启自启动和省电优化，以减少对手机性能的影响。
:::

## 下载李跳跳

这里提供两种下载方式，当然如果你自己会下载也行，我这里提供的是`2.2正式版`的下载\
\
🌏下载地址：  
[123云盘下载](https://www.123pan.com/s/4vaiVv-4txzH.html) | [本站下载](/apk/李跳跳.apk)

## 安装

下载完成后安装，如果遇到病毒风险提示请无视。

## 使用

安装完成后打开软件，将下面这个按钮打开\
![](/img/litiaotiao_1.jpg)  
首次使用需要先按照提示授予`无障碍`权限，为了更佳的使用体验，推荐开启`自启动`和`无后台限制`。  
点击开关之后如果没有授予权限会有弹窗提示，点击`OK`前往设置权限。  
:::info 手动开启无障碍教程
这里以小米手机为例，打开`设置>更多设置>无障碍>已下载的应用`，在这个页面找到`❤️李跳跳2.2`，勾选`使用❤️李跳跳2.2`。
![](/img/litiaotiao_2.jpg)
:::

## 配置规则

设置完权限后返回李跳跳，点击打开后的那个按钮下面的`更多`，进入后找到右上角三个点，点击`导入规则`，然后将下面的规则粘贴进去（点击一键复制）
::: details 规则（打开可能会卡）

```json
[
  { "1558853071": "{\"ltt_service\":false}" },
  { "-1996412420": "{\"ltt_service\":false}" },
  { "-1780149548": "{\"ltt_service\":false}" },
  { "-32262258": "{\"ltt_service\":false}" },
  { "632562628": "{\"ltt_service\":false}" },
  { "-1580054715": "{\"ltt_service\":false}" },
  { "-2026724087": "{\"ltt_service\":false}" },
  { "883375344": "{\"ltt_service\":false}" },
  { "-1523726985": "{\"ltt_service\":false}" },
  { "-180622956": "{\"ltt_service\":false}" },
  { "1007780809": "{\"ltt_service\":false}" },
  { "1689240636": "{\"ltt_service\":false}" },
  { "1682307754": "{\"ltt_service\":false}" },
  { "-266832869": "{\"ltt_service\":false}" },
  { "-1044157874": "{\"ltt_service\":false}" },
  { "-1471145549": "{\"ltt_service\":false}" },
  { "631693117": "{\"ltt_service\":false}" },
  { "1670960151": "{\"ltt_service\":false}" },
  { "1282383495": "{\"ltt_service\":false}" },
  { "-1391058652": "{\"ltt_service\":false}" },
  { "-1384869593": "{\"ltt_service\":false}" },
  { "1658803875": "{\"ltt_service\":false}" },
  { "410833448": "{\"ltt_service\":false}" },
  { "1561315581": "{\"ltt_service\":false}" },
  { "-1159486742": "{\"ltt_service\":false}" },
  { "1133592112": "{\"ltt_service\":false}" },
  { "-20685278": "{\"ltt_service\":false}" },
  { "1761925590": "{\"ltt_service\":false}" },
  { "-695601475": "{\"ltt_service\":false}" },
  { "-2121240298": "{\"ltt_service\":false}" },
  { "1300556276": "{\"ltt_service\":false}" },
  { "-1894194004": "{\"ltt_service\":false}" },
  { "1151985299": "{\"ltt_service\":false}" },
  { "-96803051": "{\"ltt_service\":false}" },
  { "-1553675162": "{\"ltt_service\":false}" },
  { "-926626226": "{\"ltt_service\":false}" },
  { "988032088": "{\"ltt_service\":false}" },
  { "-987966565": "{\"ltt_service\":false}" },
  { "-409221060": "{\"ltt_service\":false}" },
  { "-1111088531": "{\"ltt_service\":false}" },
  { "214063893": "{\"ltt_service\":false}" },
  { "140457170": "{\"ltt_service\":false}" },
  { "1898638558": "{\"ltt_service\":false}" },
  { "1030991986": "{\"ltt_service\":false}" },
  { "-1580833436": "{\"ltt_service\":false}" },
  { "-1019472588": "{\"ltt_service\":false}" },
  { "-579813130": "{\"ltt_service\":false}" },
  { "-302467380": "{\"ltt_service\":false}" },
  { "-55720427": "{\"ltt_service\":false}" },
  { "2125860599": "{\"ltt_service\":false}" },
  { "-1804170825": "{\"ltt_service\":false}" },
  { "383483018": "{\"ltt_service\":false}" },
  { "1258263993": "{\"ltt_service\":false}" },
  { "-720232801": "{\"ltt_service\":false}" },
  { "1619413228": "{\"ltt_service\":false}" },
  { "1007774986": "{\"ltt_service\":false}" },
  { "823751688": "{\"ltt_service\":false}" },
  { "1502135038": "{\"ltt_service\":false}" },
  { "406523860": "{\"ltt_service\":false}" },
  { "1953841410": "{\"ltt_service\":false}" },
  { "734836016": "{\"ltt_service\":false}" },
  { "139590805": "{\"ltt_service\":false}" },
  { "-1662886573": "{\"ltt_service\":false}" },
  { "2138142011": "{\"ltt_service\":false}" },
  { "-966992970": "{\"ltt_service\":false}" },
  { "-1847985741": "{\"ltt_service\":false}" },
  { "747648111": "{\"ltt_service\":false}" },
  { "-662099843": "{\"ltt_service\":false}" },
  { "-1948112899": "{\"ltt_service\":false}" },
  { "-1577522678": "{\"ltt_service\":false}" },
  { "-1687120871": "{\"ltt_service\":false}" },
  { "-1807140097": "{\"ltt_service\":false}" },
  { "1023018517": "{\"ltt_service\":false}" },
  { "-1216248267": "{\"ltt_service\":false}" },
  { "1818816936": "{\"ltt_service\":false}" },
  { "412375972": "{\"ltt_service\":false}" },
  { "-426991111": "{\"ltt_service\":false}" },
  { "-1063371628": "{\"ltt_service\":false}" },
  { "-1031147188": "{\"ltt_service\":false}" },
  {
    "199342455": "{\"popup_rules\":[{\"id\":\"开启推送通知\",\"action\":\"iv_close\"},{\"id\":\"tv_nps_title\",\"action\":\"img_nps_close\"}]}"
  },
  { "2109203007": "{\"ltt_service\":false}" },
  { "-1859997610": "{\"ltt_service\":false}" },
  { "1159915140": "{\"ltt_service\":false}" },
  { "124016533": "{\"ltt_service\":false}" },
  { "157330508": "{\"ltt_service\":false}" },
  { "795445823": "{\"ltt_service\":false}" },
  { "783420324": "{\"ltt_service\":false}" },
  { "1235308976": "{\"ltt_service\":false}" },
  { "-242240225": "{\"ltt_service\":false}" },
  { "-737867284": "{\"ltt_service\":false}" },
  { "946436759": "{\"ltt_service\":false}" },
  { "-312077872": "{\"ltt_service\":false}" },
  {
  ...
  { "-846675676": "{\"ltt_service\":false}" },
  { "-403799230": "{\"ltt_service\":false}" },
  { "1745831417": "{\"ltt_service\":false}" },
  {
    "-662871885": "{\"popup_rules\":[{\"id\":\"更新提示\",\"action\":\"取消\"}]}"
  },
  { "1291275382": "{\"ltt_service\":false}" },
  {
    "1309104121": "{\"popup_rules\":[{\"id\":\"立即升级\",\"action\":\"关闭\"}]}"
  },
  { "18122942": "{\"ltt_service\":false}" },
  { "449627018": "{\"ltt_service\":false}" },
  { "-465620802": "{\"ltt_service\":false}" },
  { "1855466959": "{\"ltt_service\":false}" },
  { "-693659249": "{\"ltt_service\":false}" },
  { "-836426886": "{\"ltt_service\":false}" },
  { "-901428232": "{\"ltt_service\":false}" },
  { "1919830552": "{\"ltt_service\":false}" },
  { "479624373": "{\"ltt_service\":false}" },
  { "1659748127": "{\"ltt_service\":false}" },
  { "-36238313": "{\"ltt_service\":false}" },
  { "-1980310873": "{\"ltt_service\":false}" },
  { "-1958931732": "{\"ltt_service\":false}" },
  {
    "-524659007": "{\"popup_rules\":[{\"id\":\"不感兴趣\",\"action\":\"不感兴趣\",\"times\":5}]}"
  },
  { "-1159916687": "{\"ltt_service\":false}" },
  { "1275590548": "{\"ltt_service\":false}" },
  { "-472626718": "{\"ltt_service\":false}" },
  { "1082743212": "{\"ltt_service\":false}" },
  { "1695658936": "{\"ltt_service\":false}" },
  { "155841312": "{\"ltt_service\":false}" },
  {
  ...
  { "-1257945743": "{\"ltt_service\":false}" },
  { "1162737337": "{\"ltt_service\":false}" },
  { "1698344559": "{\"ltt_service\":false}" },
  { "177421281": "{\"ltt_service\":false}" },
  {
    "-1657078324": "{\"popup_rules\":[{\"id\":\"新版本\",\"action\":\"tv_update_after\"}]}"
  },
  { "1057656485": "{\"ltt_service\":false}" },
  { "857146959": "{\"ltt_service\":false}" },
  { "-1015014248": "{\"ltt_service\":false}" },
  { "1366317212": "{\"ltt_service\":false}" },
  { "-126417998": "{\"ltt_service\":false}" },
  {
  ...
  { "2129932252": "{\"ltt_service\":false}" },
  { "1418401708": "{\"ltt_service\":false}" },
  { "520220017": "{\"ltt_service\":false}" },
  { "-676964142": "{\"ltt_service\":false}" },
  { "-423250623": "{\"ltt_service\":false}" },
  {
    "2016444138": "{\"popup_rules\":[{\"id\":\"看视频领取&会员权益\",\"action\":\"GLOBAL_ACTION_BACK\"}]}"
  },
  { "-1996098865": "{\"ltt_service\":false}" },
  { "988466048": "{\"ltt_service\":false}" },
  { "-1613200024": "{\"ltt_service\":true}" },
  { "381549133": "{\"ltt_service\":false}" },
  { "-1108862836": "{\"ltt_service\":false}" },
  { "-958707916": "{\"ltt_service\":false}" },
  { "611560884": "{\"ltt_service\":false}" },
  { "-2070325821": "{\"ltt_service\":false}" },
  { "714230169": "{\"ltt_service\":false}" },
  { "1089622123": "{\"ltt_service\":false}" },
  { "-112632922": "{\"ltt_service\":true}" },
  { "-568677847": "{\"ltt_service\":false}" },
  { "-755746661": "{\"ltt_service\":false}" },
  { "-317738405": "{\"ltt_service\":false}" },
  { "-88630604": "{\"ltt_service\":false}" },
  { "1522513929": "{\"ltt_service\":false}" },
  { "746231995": "{\"ltt_service\":false}" },
  { "1367355542": "{\"ltt_service\":false}" },
  { "1176164949": "{\"ltt_service\":false}" },
  { "-1248919307": "{\"ltt_service\":false}" },
  { "-392685682": "{\"ltt_service\":false}" },
  { "1176608565": "{\"ltt_service\":false}" },
  { "-1432891999": "{\"ltt_service\":false}" },
  { "-574435201": "{\"ltt_service\":false}" },
  { "-228476959": "{\"ltt_service\":false}" },
  { "-784707742": "{\"ltt_service\":false}" },
  { "-491974385": "{\"ltt_service\":false}" },
  { "-1155947483": "{\"ltt_service\":false}" },
  { "26776554": "{\"ltt_service\":false}" },
  { "-615243494": "{\"ltt_service\":false}" },
  { "226711854": "{\"ltt_service\":false}" },
  { "-1339293763": "{\"ltt_service\":false}" },
  { "-2050403892": "{\"ltt_service\":false}" },
  { "-12471821": "{\"ltt_service\":false}" },
  { "-553925960": "{\"ltt_service\":false}" },
  { "-611520018": "{\"ltt_service\":false}" },
  { "-765327380": "{\"ltt_service\":false}" },
  { "1355954309": "{\"ltt_service\":false}" },
  { "1011294777": "{\"ltt_service\":false}" },
  { "495554473": "{\"ltt_service\":false}" },
  {
    "-895263099": "{\"popup_rules\":[{\"id\":\"更新提示\",\"action\":\"取消\"}]}"
  },
  { "-89147402": "{\"ltt_service\":false}" },
  { "-1551683363": "{\"ltt_service\":false}" },
  {
    "-1606001344": "{\"popup_rules\":[{\"id\":\"playing_tv_redeem_title\",\"action\":\"playing_ic_close\"}]}"
  },
  { "-682962902": "{\"ltt_service\":false}" },
  {
  ...
  { "-1072300204": "{\"ltt_service\":false}" },
  { "-399239188": "{\"ltt_service\":false}" },
  { "1007788949": "{\"ltt_service\":false}" },
  {
    "560468770": "{\"popup_rules\":[{\"id\":\"openAlertText\",\"action\":\"btn_close_update_setting\"}]}"
  },
  { "1241704296": "{\"ltt_service\":false}" },
  { "-1168042103": "{\"ltt_service\":false}" },
  {
  ...
  { "-613969811": "{\"ltt_service\":false}" },
  { "1007780321": "{\"ltt_service\":false}" },
  { "-2009525831": "{\"ltt_service\":false}" },
  { "1850782852": "{\"ltt_service\":false}" },
  { "-1919219279": "{\"ltt_service\":false}" },
  { "1983115840": "{\"ltt_service\":false}" },
  { "-1924319170": "{\"ltt_service\":false}" },
  { "-1713392571": "{\"ltt_service\":false}" },
  { "1318307491": "{\"ltt_service\":false}" },
  { "-401994684": "{\"ltt_service\":false}" },
  {
    "2049668591": "{\"popup_rules\":[{\"id\":\"closeButtonIcon\",\"action\":\"closeButtonIcon\"},{\"id\":\"推荐广告\",\"action\":\"关闭\"}]}"
  },
  { "1279465997": "{\"ltt_service\":false}" },
  { "718197432": "{\"ltt_service\":false}" },
  {
  ...
  { "1953078118": "{\"ltt_service\":false}" },
  { "-224410372": "{\"ltt_service\":false}" },
  { "-410982506": "{\"ltt_service\":false}" },
  { "-268906509": "{\"ltt_service\":false}" },
  { "-562249281": "{\"ltt_service\":false}" },
  { "860368722": "{\"ltt_service\":false}" },
  {
  ...
  { "-757060337": "{\"ltt_service\":false}" },
  { "749009836": "{\"ltt_service\":false}" },
  { "-1443817253": "{\"ltt_service\":false}" },
  { "-451424362": "{\"ltt_service\":false}" },
  { "1941854859": "{\"ltt_service\":false}" },
  {
    "101952197": "{\"popup_rules\":[{\"id\":\"btn_open_notify\",\"action\":\"not_open_notify\"}]}"
  },
  { "-450869010": "{\"ltt_service\":false}" },
  { "-2011802397": "{\"ltt_service\":false}" },
  { "-1716647924": "{\"ltt_service\":false}" },
  { "-936682504": "{\"ltt_service\":false}" },
  { "141161664": "{\"ltt_service\":false}" },
  {
    "-360330826": "{\"popup_rules\":[{\"id\":\"青少年守护计划\",\"action\":\"已满14周岁\"}]}"
  },
  { "-1504102089": "{\"ltt_service\":false}" },
  {
    "876496474": "{\"popup_rules\":[{\"id\":\"立即领现金\",\"action\":\"unused_res_a\"},{\"id\":\"unused_res_a\",\"action\":\"=关闭\"}]}"
  },
  { "1156888975": "{\"ltt_service\":false}" },
  { "-103517822": "{\"ltt_service\":false}" },
  { "879657719": "{\"ltt_service\":false}" },
  { "1176596525": "{\"ltt_service\":false}" },
  { "1549307083": "{\"ltt_service\":false}" },
  { "-1803612934": "{\"ltt_service\":false}" },
  {
    "1358411530": "{\"popup_rules\":[{\"id\":\"青少年模式\",\"action\":\"我知道了\"},{\"id\":\"新人福利\",\"action\":\"close\"},{\"id\":\"打开推送提醒\",\"action\":\"关闭\"}]}"
  },
  { "596841248": "{\"ltt_service\":false}" },
  {
    "1855462465": "{\"popup_rules\":[{\"id\":\"浮层内部图片\",\"action\":\"浮层关闭按钮\"},{\"id\":\"热区\",\"action\":\"关闭按钮\"},{\"id\":\"限时福利砸中你\",\"action\":\"关闭按钮\"}]}"
  },
  { "1007788576": "{\"ltt_service\":false}" },
  { "1423571061": "{\"ltt_service\":false}" },
  { "-1606464549": "{\"ltt_service\":false}" },
  { "1181686996": "{\"ltt_service\":false}" },
  { "1430266746": "{\"ltt_service\":false}" },
  { "210580748": "{\"ltt_service\":false}" },
  { "589070971": "{\"ltt_service\":false}" },
  { "267728637": "{\"ltt_service\":false}" },
  { "-1905534484": "{\"ltt_service\":false}" },
  {
    "-1163495604": "{\"popup_rules\":[{\"id\":\"打开通知\",\"action\":\"new_user_download_right_view\"}]}"
  },
  { "406902960": "{\"ltt_service\":false}" },
  {
  ...
  { "1176157019": "{\"ltt_service\":false}" },
  { "502671992": "{\"ltt_service\":false}" },
  { "-1911802155": "{\"ltt_service\":false}" },
  {
  ...
  { "-967337015": "{\"ltt_service\":false}" },
  { "1142383184": "{\"ltt_service\":false}" },
  {
    "-557467920": "{\"popup_rules\":[{\"id\":\"开启消息通知\",\"action\":\"取消\"}]}"
  },
  { "-922377835": "{\"ltt_service\":false}" },
  {
    "-103532384": "{\"popup_rules\":[{\"id\":\"允许&发送通知\",\"action\":\"以后再说\"}]}"
  },
  { "1683535382": "{\"ltt_service\":false}" },
  { "-1849207866": "{\"ltt_service\":false}" },
  { "1093610637": "{\"ltt_service\":false}" },
  { "94480906": "{\"ltt_service\":false}" },
  { "-225098186": "{\"ltt_service\":false}" },
  { "1979512717": "{\"ltt_service\":false}" },
  { "-1782660207": "{\"ltt_service\":false}" },
  { "1712311332": "{\"ltt_service\":false}" },
  {
    "1994036591": "{\"popup_rules\":[{\"id\":\"青少年模式\",\"action\":\"我知道了\"},]}"
  },
  { "-1960782535": "{\"ltt_service\":false}" },
  {
    "992705457": "{\"popup_rules\":[{\"id\":\"青少年模式\",\"action\":\"知道了\"},{\"id\":\"开启消息通知\",\"action\":\"暂不开启\"},{\"id\":\"不要错过重要消息，试试个性化管理吧\",\"action\":\"bce\"}]}"
  },
  { "1547057220": "{\"ltt_service\":false}" },
  {
    "-1346391036": "{\"popup_rules\":[{\"id\":\"mUpgradeTitle\",\"action\":\"mUpgradeDialogCancel\"},{\"id\":\"青少年模式\",\"action\":\"我知道了\"},{\"id\":\"开启消息推送\",\"action\":\"closeIv\"}]}"
  },
  { "-464075702": "{\"ltt_service\":false}" },
  { "-949183873": "{\"ltt_service\":false}" },
  { "-1280845866": "{\"ltt_service\":false}" },
  { "1220794008": "{\"ltt_service\":false}" },
  { "455550082": "{\"ltt_service\":false}" },
  { "2033622315": "{\"ltt_service\":false}" },
  { "1149407394": "{\"ltt_service\":false}" },
  {
    "-766051647": "{\"popup_rules\":[{\"id\":\"发现新版本\",\"action\":\"放弃更新\"}]}"
  },
  { "-2060059498": "{\"ltt_service\":false}" },
  { "-1131053972": "{\"ltt_service\":false}" },
  { "1264708667": "{\"ltt_service\":false}" },
  {
  ...
  { "1215359942": "{\"ltt_service\":false}" },
  { "2008265287": "{\"ltt_service\":false}" },
  { "771820541": "{\"ltt_service\":false}" },
  { "-2079752927": "{\"ltt_service\":false}" },
  { "1559677784": "{\"ltt_service\":false}" },
  { "1186316181": "{\"ltt_service\":false}" },
  { "919260730": "{\"ltt_service\":false}" },
  { "-1930694282": "{\"ltt_service\":false}" },
  { "-1980102337": "{\"ltt_service\":false}" },
  { "1569285858": "{\"ltt_service\":false}" },
  { "833303922": "{\"ltt_service\":false}" },
  { "1003195641": "{\"ltt_service\":false}" },
  { "1309255243": "{\"ltt_service\":false}" },
  {
    "-34617839": "{\"popup_rules\":[{\"id\":\"开启定位权限\",\"action\":\"img_close\"},{\"id\":\"想获取您的位置信息\",\"action\":\"不允许\"}]}"
  },
  { "785432955": "{\"ltt_service\":false}" },
  { "-1998987979": "{\"ltt_service\":false}" },
  {
    "-945730221": "{\"popup_rules\":[{\"id\":\"open_notification_button\",\"action\":\"close_image_view\"},{\"id\":\"location_tip_tv\",\"action\":\"location_tip_close\"}]}"
  },
  { "-459285717": "{\"ltt_service\":false}" },
  { "-690395648": "{\"ltt_service\":false}" },
  {
    "1076661718": "{\"popup_rules\":[{\"id\":\"版本更新\",\"action\":\"暂不更新\"}]}"
  },
  { "1871008311": "{\"ltt_service\":false}" },
  { "-695600961": "{\"ltt_service\":false}" },
  { "-723363372": "{\"ltt_service\":false}" },
  { "-1164725242": "{\"ltt_service\":false}" },
  { "-1265229428": "{\"ltt_service\":false}" },
  { "-695599736": "{\"ltt_service\":false}" },
  { "-384534904": "{\"ltt_service\":false}" },
  { "469096949": "{\"ltt_service\":false}" },
  { "-2012183398": "{\"ltt_service\":false}" },
  { "-1680573276": "{\"ltt_service\":false}" },
  {
    "502255059": "{\"popup_rules\":[{\"id\":\"青少年模式\",\"action\":\"我知道了\"},{\"id\":\"开启消息通知\",\"action\":\"arg\"}]}"
  },
  { "-1165992731": "{\"ltt_service\":false}" },
  { "-156744385": "{\"ltt_service\":false}" },
  { "1648365911": "{\"ltt_service\":false}" },
  { "1702579662": "{\"ltt_service\":false}" },
  { "-583737491": "{\"ltt_service\":false}" },
  { "-1081439172": "{\"ltt_service\":false}" },
  { "350579580": "{\"ltt_service\":false}" },
  { "-1113684289": "{\"ltt_service\":false}" },
  { "958768150": "{\"ltt_service\":false}" },
  { "566855000": "{\"ltt_service\":false}" },
  {
  ...
  { "-128398808": "{\"ltt_service\":false}" },
  {
    "515982662": "{\"popup_rules\":[{\"id\":\"开启定位权限\",\"action\":\"locate_iv_close\"},{\"id\":\"marquee\",\"action\":\"关闭\"},{\"id\":\"fortune_adv\",\"action\":\"关闭\"}]}"
  },
  { "332130040": "{\"ltt_service\":false}" },
  { "-1447683469": "{\"ltt_service\":false}" },
  { "1138787806": "{\"ltt_service\":false}" },
  { "1007786051": "{\"ltt_service\":false}" },
  { "1035750756": "{\"ltt_service\":false}" },
  { "1856099985": "{\"ltt_service\":false}" },
  { "1854207706": "{\"ltt_service\":false}" },
  { "159100921": "{\"ltt_service\":false}" },
  { "-88748562": "{\"ltt_service\":false}" },
  {
    "-1031558479": "{\"popup_rules\":[{\"id\":\"发现新版本\",\"action\":\"GLOBAL_ACTION_BACK\"},{\"id\":\"送你&新人购物券\",\"action\":\"GLOBAL_ACTION_BACK\"},]}"
  },
  { "-2066048740": "{\"ltt_service\":false}" },
  {
    "2078928257": "{\"popup_rules\":[{\"id\":\"activity_guide_animation\",\"action\":\"跳过\"},{\"id\":\"打开通知权限\",\"action\":\"取消\"}]}"
  },
  { "-1674404901": "{\"ltt_service\":false}" },
  { "-1558913047": "{\"ltt_service\":false}" },
  { "1467460851": "{\"ltt_service\":false}" },
  {
    "-1053900032": "{\"popup_rules\":[{\"id\":\"suite_completed_ads_container\",\"action\":\"suite_completed_close_ad_button\"}]}"
  },
  { "1901269468": "{\"ltt_service\":false}" },
  { "-205204913": "{\"ltt_service\":false}" },
  { "1144435398": "{\"ltt_service\":false}" },
  { "1438354509": "{\"ltt_service\":false}" },
  { "1948807874": "{\"ltt_service\":false}" },
  { "419243711": "{\"ltt_service\":false}" },
  { "708170498": "{\"ltt_service\":false}" },
  { "1889463618": "{\"ltt_service\":false}" },
  { "35386857": "{\"ltt_service\":false}" },
  { "-188372687": "{\"ltt_service\":false}" },
  { "34803276": "{\"ltt_service\":false}" },
  { "349888121": "{\"ltt_service\":false}" },
  { "-1444878531": "{\"ltt_service\":false}" },
  { "648214281": "{\"ltt_service\":false}" },
  { "-1053666344": "{\"ltt_service\":false}" },
  { "-129107348": "{\"ltt_service\":false}" },
  { "200355416": "{\"ltt_service\":false}" },
  { "593289926": "{\"ltt_service\":false}" },
  { "841622615": "{\"ltt_service\":false}" },
  { "-1217460914": "{\"ltt_service\":false}" },
  { "-454809807": "{\"ltt_service\":false}" },
  { "299942782": "{\"ltt_service\":false}" },
  { "-1398232393": "{\"ltt_service\":false}" },
  {
    "1644138715": "{\"popup_rules\":[{\"id\":\"为你推荐\",\"action\":\"jkr\"},{\"id\":\"不再显示推荐电台\",\"action\":\"关闭推荐\"}]}"
  },
  { "-695595714": "{\"ltt_service\":false}" },
  {
    "-506597855": "{\"popup_rules\":[{\"id\":\"版本更新\",\"action\":\"取消\"}]}"
  },
  { "475200648": "{\"ltt_service\":false}" },
  { "-670757087": "{\"ltt_service\":false}" },
  {
  ...
  { "-1044199650": "{\"ltt_service\":false}" },
  { "472073234": "{\"ltt_service\":false}" },
  { "1544296322": "{\"ltt_service\":false}" },
  { "-916144683": "{\"ltt_service\":false}" },
  { "1657549393": "{\"ltt_service\":false}" },
  {
  ...
  { "-696802362": "{\"ltt_service\":false}" },
  { "1722233181": "{\"ltt_service\":false}" },
  { "951871474": "{\"ltt_service\":false}" },
  {
  ...
  { "464074798": "{\"ltt_service\":false}" },
  { "-2024124123": "{\"ltt_service\":false}" },
  { "699180000": "{\"ltt_service\":false}" },
  { "1801616019": "{\"ltt_service\":false}" },
  { "-2054103605": "{\"ltt_service\":false}" },
  { "543597367": "{\"filter_young_popups\":true}" },
  { "1949578072": "{\"ltt_service\":false}" },
  { "518195962": "{\"ltt_service\":false}" },
  { "-2079461154": "{\"ltt_service\":false}" },
  { "-364439457": "{\"ltt_service\":false}" },
  { "-317334757": "{\"ltt_service\":false}" },
  { "2075805265": "{\"ltt_service\":false}" },
  { "-1414892808": "{\"ltt_service\":false}" },
  { "-1908633887": "{\"ltt_service\":false}" },
  { "906487690": "{\"ltt_service\":false}" },
  { "1165734676": "{\"ltt_service\":false}" },
  { "1912413455": "{\"ltt_service\":false}" },
  { "-2040890594": "{\"ltt_service\":false}" },
  { "-2000613062": "{\"ltt_service\":false}" },
  { "-205002697": "{\"ltt_service\":false}" },
  { "-1418176987": "{\"ltt_service\":false}" },
  { "1124128502": "{\"ltt_service\":false}" },
  {
    "-527086868": "{\"popup_rules\":[{\"id\":\"gift_img\",\"action\":\"gift_close\"},{\"id\":\"打开系统通知\",\"action\":\"iv_close\"}]}"
  },
  { "-423344899": "{\"ltt_service\":false}" },
  { "-1626079545": "{\"ltt_service\":false}" },
  {
    "2130042610": "{\"popup_rules\":[{\"id\":\"青少年模式\",\"action\":\"我知道了\"}]}"
  },
  { "-2041969869": "{\"ltt_service\":false}" },
  { "2109557567": "{\"ltt_service\":false}" },
  {
    "1060301516": "{\"popup_rules\":[{\"id\":\"182,665,1258,1206\",\"action\":\"647,2277,793,2423\"}],\"ltt_service\":true}"
  },
  { "-1619647038": "{\"ltt_service\":false}" },
  { "-1109329050": "{\"ltt_service\":false}" },
  { "-1200662948": "{\"ltt_service\":false}" },
  { "1587922649": "{\"ltt_service\":false}" },
  {
    "163972830": "{\"popup_rules\":[{\"id\":\"新客礼包\",\"action\":\"btn_close\"},{\"id\":\"新客礼包\",\"action\":\"x:1150y:1018\"}]}"
  },
  { "-986089018": "{\"ltt_service\":false}" },
  { "toast_text": "跳过" },
  { "673009131": "{\"ltt_service\":false}" },
  { "2105508070": "{\"filter_young_popups\":true}" },
  { "-706605499": "{\"ltt_service\":false}" },
  { "93744591": "{\"ltt_service\":false}" },
  {
    "-1443118090": "{\"popup_rules\":[{\"id\":\"Update\",\"action\":\"UPDATE\"}]}"
  },
  { "1478097699": "{\"ltt_service\":false}" },
  {
    "-1892077856": "{\"popup_rules\":[{\"id\":\"检测到新版本\",\"action\":\"取消\"},{\"id\":\"banner_ad\",\"action\":\"iv_ad_close\"}]}"
  },
  { "-1122119362": "{\"ltt_service\":false}" },
  { "-2077115880": "{\"ltt_service\":false}" },
  {
  ...
  { "997165763": "{\"ltt_service\":false}" },
  { "1007773862": "{\"ltt_service\":false}" },
  { "2138355065": "{\"ltt_service\":false}" },
  { "-72921587": "{\"ltt_service\":false}" },
  {
    "-91332804": "{\"popup_rules\":[{\"id\":\"开启推送通知\",\"action\":\"下次再说\"}]}"
  },
  { "247235309": "{\"ltt_service\":false}" },
  {
    "270694045": "{\"popup_rules\":[{\"id\":\"开启消息通知\",\"action\":\"GLOBAL_ACTION_BACK\"}]}"
  },
  { "249395008": "{\"ltt_service\":false}" },
  { "-236834487": "{\"ltt_service\":false}" },
  {
    "-1960346768": "{\"popup_rules\":[{\"id\":\"ad_content\",\"action\":\"btnClose\"}]}"
  },
  { "-1840298925": "{\"ltt_service\":false}" },
  { "-160985922": "{\"ltt_service\":false}" },
  { "-861391249": "{\"ltt_service\":false}" },
  { "2115225594": "{\"ltt_service\":false}" },
  { "-1836637249": "{\"ltt_service\":false}" },
  {
    "1884443122": "{\"popup_rules\":[{\"id\":\"想要读取剪切板\",\"action\":\"始终拒绝\"}]}"
  },
  { "1148125061": "{\"ltt_service\":false}" },
  { "-1232966247": "{\"ltt_service\":false}" },
  { "-1873044753": "{\"ltt_service\":false}" },
  {
    "-379148275": "{\"popup_rules\":[{\"id\":\"=跳过\",\"action\":\"=跳过\"}],\"click_way_popup\":1}"
  },
  { "658193839": "{\"popup_rules\":[{\"id\":\"提示\",\"action\":\"进入\"}]}" },
  {
  ...
  { "1709838191": "{\"ltt_service\":false}" },
  { "1845080487": "{\"ltt_service\":false}" },
  {
    "-1854575849": "{\"popup_rules\":[{\"id\":\"查看&分享的文件\",\"action\":\"立即查看\"}]}"
  },
  { "522830646": "{\"ltt_service\":false}" },
  {
    "2029054607": "{\"popup_rules\":[{\"id\":\"tt_splash_ad_logo\",\"action\":\"tt_splash_skip_btn\"}]}"
  },
  { "-2011526028": "{\"ltt_service\":false}" },
  { "941834830": "{\"ltt_service\":false}" },
  { "2053740756": "{\"ltt_service\":false}" },
  { "663992374": "{\"ltt_service\":false}" },
  {
    "-146860486": "{\"popup_rules\":[{\"id\":\"点击成为VIP，立享高级功能\",\"action\":\"close_btn\"},{\"id\":\"获取地理位置\",\"action\":\"dialog_close\"}]}"
  },
  { "-416186095": "{\"ltt_service\":false}" },
  { "-1057586422": "{\"ltt_service\":false}" },
  { "-1224958293": "{\"ltt_service\":false}" },
  {
    "-1902185409": "{\"popup_rules\":[{\"id\":\"首次成功发布沸点\",\"action\":\"iv_close\"}]}"
  },
  { "-1936906284": "{\"ltt_service\":false}" },
  {
    "-30315083": "{\"popup_rules\":[{\"id\":\"有新版本\",\"action\":\"取消\"}]}"
  },
  { "1532858367": "{\"ltt_service\":false}" },
  {
    "-1877153607": "{\"popup_rules\":[{\"id\":\"给您发送通知\",\"action\":\"不接收\"}]}"
  },
  { "-1180843680": "{\"ltt_service\":false}" },
  { "-1768141830": "{\"ltt_service\":false}" },
  { "-1098338944": "{\"ltt_service\":false}" },
  {
  ...
  { "-1056969215": "{\"ltt_service\":false}" },
  {
    "1337821420": "{\"popup_rules\":[{\"id\":\"请开启消息通知\",\"action\":\"暂不开启\"}]}"
  },
  { "508939580": "{\"ltt_service\":false}" },
  { "-1244425476": "{\"ltt_service\":false}" },
  {
    "132785423": "{\"popup_rules\":[{\"id\":\"发现新版本\",\"action\":\"iv_cancel\"},{\"id\":\"开启&通知\",\"action\":\"暂不开启\"},{\"id\":\"签到成功\",\"action\":\"iv_close\"}]}"
  },
  { "-1815138218": "{\"ltt_service\":false}" },
  { "547207096": "{\"ltt_service\":false}" },
  {
  ...
  { "-2093248300": "{\"ltt_service\":false}" },
  { "-1497336294": "{\"ltt_service\":false}" },
  {
  ...
  { "1984549464": "{\"ltt_service\":false}" },
  { "-1604505885": "{\"ltt_service\":false}" },
  {
  ...
  { "109270498": "{\"ltt_service\":false}" },
  { "-84365111": "{\"ltt_service\":false}" },
  { "-1236223966": "{\"ltt_service\":false}" },
  {
  ...
  { "674376896": "{\"ltt_service\":false}" },
  { "-2053310312": "{\"ltt_service\":false}" },
  {
    "229330387": "{\"popup_rules\":[{\"id\":\"=开启推送通知\",\"action\":\"以后再说\"},{\"id\":\"+开启推送通知\",\"action\":\"bn0\"},{\"id\":\"青少年模式\",\"action\":\"=我知道了\"}]}"
  },
  { "1118279821": "{\"ltt_service\":false}" },
  { "872866569": "{\"ltt_service\":false}" },
  {
  ...
  { "-1449284004": "{\"ltt_service\":false}" },
  { "1128028478": "{\"ltt_service\":false}" },
  {
    "-189732215": "{\"popup_rules\":[{\"id\":\"banner_image\",\"action\":\"image_close_banner\"}]}"
  },
  { "-479849501": "{\"ltt_service\":false}" },
  {
  ...
  { "-1836897030": "{\"ltt_service\":false}" },
  { "-2013769423": "{\"ltt_service\":false}" },
  { "1591094786": "{\"ltt_service\":false}" },
  {
  ...
  { "335777953": "{\"ltt_service\":false}" },
  {
    "460049591": "{\"popup_rules\":[{\"id\":\"开启青少年模式\",\"action\":\"知道了\"}]}"
  },
  { "704051193": "{\"ltt_service\":false}" },
  { "1618836628": "{\"ltt_service\":false}" },
  {
  ...
  { "1001548280": "{\"ltt_service\":false}" },
  { "1980729128": "{\"ltt_service\":false}" },
  {
  ...
  { "1738998202": "{\"ltt_service\":false}" },
  { "1004703791": "{\"ltt_service\":false}" },
  { "783971912": "{\"ltt_service\":false}" },
  { "-1505823314": "{\"ltt_service\":false}" },
  { "-1119993449": "{\"ltt_service\":false}" },
  { "-1870606499": "{\"ltt_service\":false}" },
  {
  ...
  { "-1522750617": "{\"ltt_service\":false}" },
  { "147910810": "{\"ltt_service\":false}" },
  {
  ...
  { "1037474056": "{\"ltt_service\":false}" },
  { "-1386851385": "{\"ltt_service\":false}" },
  {
    "991562021": "{\"popup_rules\":[{\"id\":\"青少年模式\",\"action\":\"我知道了\"}]}"
  },
  { "-1956632531": "{\"ltt_service\":false}" },
  {
  ...
  { "781218186": "{\"ltt_service\":false}" },
  { "-1079018115": "{\"ltt_service\":false}" },
  {
  ...
  { "640747243": "{\"ltt_service\":false}" },
  {
    "1575109845": "{\"popup_rules\":[{\"id\":\"开启系统通知\",\"action\":\"iv_close\"}]}"
  },
  { "-1271637571": "{\"ltt_service\":false}" },
  {
  ...
  { "345986888": "{\"ltt_service\":false}" },
  { "-1179567085": "{\"ltt_service\":false}" },
  { "1832415590": "{\"ltt_service\":false}" },
  {
  ...
  { "1387963950": "{\"ltt_service\":false}" },
  {
    "325847140": "{\"popup_rules\":[{\"id\":\"打开推送通知\",\"action\":\"不允许\"}]}"
  },
  { "1478309988": "{\"ltt_service\":false}" },
  { "2056137632": "{\"ltt_service\":false}" },
  {
  ...
  {
    "163972831": "{\"popup_rules\":[{\"id\":\"新客礼包\",\"action\":\"x:1150y:1018\"}]}"
  },
  {
  ...
  { "305747877": "{\"ltt_service\":false}" },
  { "-1421674793": "{\"ltt_service\":false}" },
  ...
  { "-884695971": "{\"ltt_service\":false}" },
  { "-1691986018": "{\"ltt_service\":false}" },
  { "999276286": "{\"popup_rules\":[{\"id\":\"提示\",\"action\":\"确定\"}]}" },
  {
    "953551389": "{\"popup_rules\":[{\"id\":\"使用您的位置\",\"action\":\"暂不\"}]}"
  },
  { "458870127": "{\"ltt_service\":false}" },
  {
  ...
  { "-1767909277": "{\"ltt_service\":false}" },
  { "1956482602": "{\"ltt_service\":false}" },
  {
  ...
  { "-1517905170": "{\"ltt_service\":false}" },
  {
    "1970409442": "{\"popup_rules\":[{\"id\":\"监护人同意\",\"action\":\"已满14岁\"}]}"
  },
  { "-881575644": "{\"ltt_service\":false}" },
  {
  ...
  { "895256435": "{\"ltt_service\":false}" },
  { "-1330547633": "{\"ltt_service\":false}" },
  {
  ...
  { "325967443": "{\"ltt_service\":false}" },
  { "-1967922816": "{\"ltt_service\":false}" },
  {
  ...
  { "-2136902461": "{\"ltt_service\":false}" },
  {
    "2037736697": "{\"popup_rules\":[{\"id\":\"ad_container\",\"action\":\"splash_ad_skip\"}]}"
  },
  { "1877659010": "{\"popup_rules\":[]}" },
  { "-572565639": "{\"ltt_service\":false}" },
  { "669871310": "{\"ltt_service\":false}" },
  {
  ...
  { "-1231208247": "{\"ltt_service\":false}" },
  { "-1347546289": "{\"ltt_service\":false}" },
  {
  ...
  { "-826127041": "{\"ltt_service\":false}" },
  { "-15215233": "{\"ltt_service\":false}" },
  {
    "-1239952740": "{\"popup_rules\":[{\"id\":\"为什么不希望看到这条推广\",\"action\":\"不感兴趣\"}]}"
  },
  { "1470299331": "{\"ltt_service\":false}" },
  { "2117691547": "{\"ltt_service\":false}" },
  {
  ...
  { "-1229735281": "{\"ltt_service\":false}" },
  {
    "2123438483": "{\"popup_rules\":[{\"id\":\"iv_coupon\",\"action\":\"iv_close\"}]}"
  },
  { "ltt_suggestions_a": false },
  {
  ...
  { "-482337716": "{\"ltt_service\":false}" },
  { "-1180565270": "{\"ltt_service\":false}" },
  {
  ...
  { "-1552480341": "{\"ltt_service\":false}" },
  { "-2000648992": "{\"ltt_service\":false}" },
  { "176488897": "{\"ltt_service\":false}" },
  {
...
:::
:::warning 注意
这里不要使用输入法的快捷粘贴！会导致规则粘贴不完整，长按输入框然后点击`粘贴`。
:::
粘贴完规则后点击保存即可正常使用了！

## 鸣谢🎉

- [大小姐李跳跳](https://weibo.com/u/7266690401)
